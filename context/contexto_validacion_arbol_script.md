# Contexto para Validación de Árbol (Script)
...
- El sistema de alias de género es la única vía permitida para manejar sinónimos; la clasificación debe usar nombres exactos definidos en la taxonomía.
